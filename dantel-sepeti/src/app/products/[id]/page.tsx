...
import { getProductById, demoProducts } from "@/lib/demo-data";
                    ...
                    <button
                      ...
                      className={`px-4 py-2.5 font-sans text-xs tracking-[0.15em] uppercase border transition-all ${
                        selectedSize === size
                          ...
                          : "border-obsidian-500 text-ivory-400 hover:border-gold-500/40 hover:text-ivory-200"
                      }`}
                    >
                      {size}
                    </button>
